...
<li>
	...
	<?php require realpath( __DIR__ . '/render-list-item-meta.php' ); ?>
	<?php require realpath( __DIR__ . '/render-list-item-title.php' ); ?>

		<div class="postInfo-container">
		<?php require realpath( __DIR__ . '/render-list-item-date.php' ); ?>

		<?php if ( $show_post_date && $show_author ) : ?>
			<span class="linkList-authorDivider"></span>
		<?php endif; ?>

		<?php require realpath( __DIR__ . '/render-list-item-author.php' ); ?>
		</div>
	</article>
</li>
