...
import BackgroundImageOriginControl from '../../components/BackgroundImageOriginControl.jsx';
import BackgroundImageSelectorControl from '../../components/BackgroundImageSelectorControl.jsx';
...
export default function Edit({ attributes, setAttributes }) {
  ...
  useEffect(() => {
    if (attributes.backgroundImageId) {
      fetchMediaData(attributes.backgroundImageId, setImageData);
    }
  ...
  return (
    <>
      ...
      <section
        {...useBlockProps({ className: sectionClasses })}
        style={buildStyles(attributes.minHeight)}
      >
