...
$wrapper_attributes = get_block_wrapper_attributes( [ 'class' => $slide_classes ] );

?>

<div id="slide-<?php echo esc_attr( $html_id ); ?>" <?php echo wp_kses_data( $wrapper_attributes ); ?> style="<?php echo esc_attr( $slide_style ); ?>" tabindex="0">
...
<?php if ( ! $hide_content ) : ?>
	<?php if ( $has_content ) : ?>
		<div class="slide-contentWrapper" tabindex="0">
			...
			<?php if ( $slide_title ) : ?>
				<h1 class="slide-title"><?php echo wp_kses_post( $slide_title ); ?></h1>
			<?php endif; ?>
