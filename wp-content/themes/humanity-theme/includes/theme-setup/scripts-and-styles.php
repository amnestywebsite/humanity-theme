...
if ( ! function_exists( 'amnesty_block_enqueue_shared_assets' ) ) {
	...
	function amnesty_block_enqueue_shared_assets() {
		...
		wp_register_style(
			'amnesty-links-with-icons-style',
			get_template_directory_uri() . '/build/blocks-deprecated/links-with-icons/style-index.css',
			[],
			$theme->get( 'Version' )
		);
		...
		// Section block
		wp_register_style(
			'amnesty-section-style',
			get_template_directory_uri() . '/build/blocks/section/style-index.css',
			[],
			$theme->get( 'Version' )
		);
...
if ( ! function_exists( 'amnesty_block_enqueue_editor_assets' ) ) {
	...
	function amnesty_block_enqueue_editor_assets() {
		...
		// Links with Icons block
		wp_register_style(
			'amnesty-links-with-icons-editor-style',
			get_template_directory_uri() . '/build/blocks-deprecated/links-with-icons/index.css',
			[],
			$theme->get( 'Version' )
		);
		...
		// Section block
		wp_register_style(
			'amnesty-section-editor-style',
			get_template_directory_uri() . '/build/blocks/section/index.css',
			[],
			$theme->get( 'Version' )
		);
