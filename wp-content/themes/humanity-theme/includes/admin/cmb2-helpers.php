...
if ( ! function_exists( 'amnesty_cmb2_wrap_open' ) ) {
	 ...
	 * @return void
	 */
	function amnesty_cmb2_wrap_open( mixed $metabox, string $title = '', bool $closed = false, bool $hidden = false, array $data = [] ) {
		$metabox->add_field(
			[
				'id'            => random_bytes( 4 ),
				'type'          => 'noop',
...
if ( ! function_exists( 'amnesty_cmb2_wrap_close' ) ) {
	 ...
	 * @return void
	 */
	function amnesty_cmb2_wrap_close( mixed $metabox ) {
		$metabox->add_field(
			[
				'id'            => random_bytes( 4 ),
				'type'          => 'noop',
...
if ( ! function_exists( 'amnesty_sanitize_checkbox' ) ) {
	 ...
	 * @return mixed
	 */
	function amnesty_sanitize_checkbox( mixed $override_value, mixed $value ) {
