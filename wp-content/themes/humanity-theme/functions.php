...
if (class_exists('\WooCommerce', false) ) {
    include_once realpath(__DIR__ . '/includes/admin/woo/theme-options.php');

    include_once realpath(__DIR__ . '/includes/woo/helpers.php');
    include_once realpath(__DIR__ . '/includes/woo/cart.php');
    include_once realpath(__DIR__ . '/includes/woo/checkout.php');
    include_once realpath(__DIR__ . '/includes/woo/emails.php');
    include_once realpath(__DIR__ . '/includes/woo/form-fields.php');
    include_once realpath(__DIR__ . '/includes/woo/menus.php');
    include_once realpath(__DIR__ . '/includes/woo/order.php');
    include_once realpath(__DIR__ . '/includes/woo/product.php');
    include_once realpath(__DIR__ . '/includes/woo/select-element.php');
    include_once realpath(__DIR__ . '/includes/woo/templates.php');
}
...
if (is_multilingualpress_enabled() ) {
    include_once realpath(__DIR__ . '/includes/mlp/polyfills.php');
    include_once realpath(__DIR__ . '/includes/mlp/metadata.php');
    include_once realpath(__DIR__ . '/includes/mlp/rest-api.php');
    include_once realpath(__DIR__ . '/includes/mlp/scheduled-posts.php');
}
