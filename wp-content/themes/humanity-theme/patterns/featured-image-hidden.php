...
<!-- wp:group {"className":"is-style-square-border container","layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-square-border container"><!-- wp:paragraph {"align":"center","fontSize":"large"} -->
