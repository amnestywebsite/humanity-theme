<?php
/**
 * Title: 50/50 Text with Video (text on left, video on right)
 * Description: A 50/50 layout with text on one side and a video on the other.
 * Slug: amnesty/50-50-text-with-video-left
 * Keywords: 50/50, text, video
 * Categories: humanity-media, humanity-halves, humanity-two-columns
 */
?>
