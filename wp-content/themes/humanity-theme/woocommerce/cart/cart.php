		...
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-subtotal" data-title="<?php /* translators: [front] Donate */ esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
			...
			<tr>
				...
				<?php if ( wc_coupons_enabled() ) : ?>
					<div class="coupon">
						<label for="coupon_code"><?php /* translators: [front] Donate */ esc_html_e( 'Coupon:', 'woocommerce' ); ?></label> <input id="coupon_code" class="input-text input-fixed" type="text" name="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> <button type="submit" class="btn btn--dark btn--small" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
						<?php do_action( 'woocommerce_cart_coupon' ); ?>
					</div>
				<?php endif; ?>

					<button type="submit" class="btn btn--dark" name="update_cart" value="<?php /* translators: [front] Donate */ esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php /* translators: [front] Donate */ esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
