...
?>
<ul class="aimc-ignore article-share" role="complementary" aria-label="<?php /* translators: [front] https://wordpresstheme.amnesty.org/the-theme/global-elements/m004-social-share/ Accessibility text */ esc_attr_e( 'Social sharing options', 'amnesty' ); ?>">
	<li>
