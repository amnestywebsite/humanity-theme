...
if ( ! function_exists( 'humanity_register_shared_assets' ) ) {
	...
	function humanity_register_shared_assets(): void {
		...
		if ( file_exists( __DIR__ . $ds . 'shared' . $ds . 'index.asset.php' ) ) {
			$data = require_once __DIR__ . $ds . 'shared' . $ds . 'index.asset.php';
			$deps = $data['dependencies'] ?? [];
		}

		wp_enqueue_style( 'humanity-theme-shared', get_template_directory_uri() . '/build/shared/index.css', $deps, $theme->get( 'Version' ) );
	}
}
